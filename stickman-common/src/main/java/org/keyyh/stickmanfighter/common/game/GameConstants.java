...
public final class GameConstants {
    ...
    public static final double MAX_STAMINA = 200;

    // Chi phí thể lực
    public static final double JUMP_STAMINA_COST = 2;
    public static final double DASH_STAMINA_COST = 5;
    public static final double PUNCH_STAMINA_COST = 1;
    public static final double KICK_STAMINA_COST = 1.5;

    // Sát thương cơ bản
    public static final double PUNCH_DAMAGE = 10;
    public static final double KICK_DAMAGE = 15;
}